...
from utils.load_tfrecord2 import *
...
#for tr_num,_ in  enumerate(tf.python_io.tf_record_iterator("caltech101/train28x28.tfrecord")):pass
#for ts_num,_ in  enumerate(tf.python_io.tf_record_iterator("caltech101/test28x28.tfrecord" )):pass
tr_num = 1461; ts_num = 1445

tr_img, tr_label = load_tfrecord("caltech101/train28x28.tfrecord")
ts_img, ts_label = load_tfrecord("caltech101/test28x28.tfrecord" )
